...
studies = ['GCMP']#'GCMP', 'GSMP', 'human_gut', 'milk', 'peru_ants', 'song', 'song_Amphibia', 'song_Arachnida', 'song_Aves', 'song_Hyperoartia', 'song_Insecta', 'song_Lepidosauria', 'song_Leptocardii', 'song_Mamallia', 'song_Mammalia', 'song_Reptilia', 'song_Sagittoidea', 'mocks']
