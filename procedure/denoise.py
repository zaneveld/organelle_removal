...
for study, lane_count in lanes.items():
    ...
    d2_filtered_merged_table.save(join(working_dir, 'input', study, study + '_' + str(lane) + '_dada2_filtered_merged_ft.qza'))
    d2_filtered_merged_seqs.save(join(working_dir, 'input', study, study + '_' + str(lane) + '_dada2_filtered_merged_seqs.qza'))
