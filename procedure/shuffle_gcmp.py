...
for study in ['GCMP', 'mocks']:
    rep_seqs = Artifact.load(join(working_dir, 'input', study + '_dada2_unfiltered_merged_seqs.qza'))
    ...
    shuffled_seqs.save(join(working_dir, 'input', study + '_shuffled_dada2_merged_seqs.qza'))
