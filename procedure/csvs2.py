...
def main_function():
    ...
    studies = ['GCMP']#, 'GSMP', 'human_gut', 'milk', 'peru_ants', 'mocks', 'song', 'song_Amphibia', 'song_Arachnida', 'song_Aves', 'song_Hyperoartia', 'song_Insecta', 'song_Lepidosauria', 'song_Leptocardii', 'song_Mamallia', 'song_Mammalia', 'song_Reptilia', 'song_Sagittoidea']
    denoisers = ['dada2', 'dada2_filtered', 'deblur', 'deblur_unfiltered']
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        results.to_csv(working_dir + '/output/proportions2.csv')
