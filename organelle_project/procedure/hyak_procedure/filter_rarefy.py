...
for study in ['GCMP', 'GSMP', 'human_gut', 'milk', 'peru_ants']:
    for denoiser in ['dada2', 'deblur']:
        ft = Artifact.load('/gscratch/zaneveld/sonettd/organelle_removal/output/' + study + '_' + denoiser + '_merged_ft.qza')
        seqs = Artifact.load('/gscratch/zaneveld/sonettd/organelle_removal/output/' + study + '_' + denoiser + '_merged_seqs.qza')
