...
for study in ['GCMP']:#peru_ants', 'GCMP', 'GSMP', 'human_gut', 'milk']:
    for denoiser in ['dada2', 'deblur']:
        rep_seqs = Artifact.load(working_dir + '/output/' + study + '_' + denoiser + '_merged_seqs.qza')
        rooted_tree, placements = sepp(rep_seqs, sepp_ref, 35)
